...
def classify_images(images_dir, results_dic, model):
    ...
    for key,value in results_dic.items():
        ...
        breed_match = 0
        breed = image_classification
        for breed_item in image_classification.split(','):
            if value[0].lower() == breed_item.strip().lower():
                breed_match = 1
                breed = breed_item
                break

        value.append(breed.strip().lower())
        value.append(breed_match)
